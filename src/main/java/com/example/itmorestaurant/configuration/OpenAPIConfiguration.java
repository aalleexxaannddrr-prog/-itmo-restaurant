package com.example.itmorestaurant.configuration;

import com.example.itmorestaurant.handlers.ErrorResponse;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                title = "Itmo Restaurant",
                description = "Реализация учебной версии сервисного веб-приложения по бронированию столов в ресторане",
